...
code_dict_comp_simple_with_none_check = """
results = {obj: v if (v := out_data.get(obj, 0.0)) is not None else 0.0 for obj in objectives}
"""
...
print("Dict Comp (simple with none check):", timeit.timeit(code_dict_comp_simple_with_none_check, setup=setup, number=100000))
